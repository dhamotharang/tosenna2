...
<HTML>
  <HEAD>
    <title>Relyon HRMS</title>
  	<link rel="stylesheet" type="text/css" href="CSS/CommonStyles.css" id="CommonCss" runat="server" ></link>
    <script runat="server">

    </script>
</head>
<body background="Images/background_color.jpg">
<form id="form1" runat="server">
<div style="text-align: center; margin-top:-35px; margin-left: -125px; position: absolute;top: 30%; left: 40%; height:90px;">
<table cellspacing="0" cellpadding="1" border="0" id="login1" style="border-collapse:collapse;" bgcolor="white">
	...
	<tr>		
		<td><table cellpadding="0" border="0" width="510px" >
			<tr ><td align="center" colspan="2" class="colheader"> Employee Log In</td></tr>
