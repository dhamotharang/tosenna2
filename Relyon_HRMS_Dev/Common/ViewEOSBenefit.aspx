...
<tr><td width="100%">
    <fieldset><legend>My End of Service Benefit Statement (Projected)</legend>
...
<tr id="table1"><td width="100%">
      <table width="100%" border="0" class="Partgrayblock" >
            ...
            <tr bgcolor="lightgray"><td colspan="4" class="mainheadtxt4" align="center">Employee End of Service Benefit Statement(Projected)</td>
            </tr>  
            
            <tr>
		       <td class="mainheadtxt3" colspan="4" width="100%">
		        <table width="100%">
		            <tr width="100%"><td colspan="4">Employee Service Information</td>
	      ...
	      <tr><td colspan="4"><hr /></td></tr>  
           <tr>
		       <td class="mainheadtxt3" colspan="4" width=100%>
		        <table width="100%">
		            <tr><td colspan="5">Monthly Entitlements</td></tr>
   		            <tr><td colspan="5">&nbsp;</tr>           
		            <tr>
            ...
            <tr>
		       <td class="mainheadtxt3" colspan="4" width=100%>
		        <table width="100%">
		            <tr ><td colspan="5">End of Service Benefits</td></tr>
  		            <tr><td colspan="5">&nbsp;</tr>           
		            <tr>
            ...
            <tr>
		       <td class="mainheadtxt3" colspan="4">
		        <table width="100%">
		            <tr><td colspan="5">Monthly Deductions</td></tr>
  		            <tr><td colspan="5">&nbsp;</tr>           
		            <tr>
            ...
            <tr>
		       <td class="mainheadtxt3" colspan="4">
		        <table width="100%">
		            <tr><td colspan="5">Total Net EOS Benefits</td></tr>
		            <tr><td colspan="5">&nbsp;</tr>           
		            <tr>
		                <td class="mainheadtxt" colspan="2">Total Net End of Service Payment(Approximate)</td> 
		                <td class="mainheadtxt" colspan="3">&nbsp;</td> 
		            </tr>		        
		            <tr>
		                <td class="mainheadtxt" colspan="2"><asp:textbox id="Tab1_TotalNetPay" cssclass="textfield"    width="200px"  runat="server" /></td> 
		                <td class="mainheadtxt" colspan="3">&nbsp;</td> 
		            </tr>		        
		        </table> 
		       </td>
