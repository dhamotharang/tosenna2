...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr><td width="100%"> 
    <fieldset><legend>Add/Update Employee Skills</legend>
      <table width="100%" border="0" class="Partgrayblock">
            ...
            <tr  align=center>
			    <td  valign="middle" colspan="3"><center><asp:button id=EmpSkill_Save runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Save"></asp:button>
            ...
            <!-- Emergency Contact Grid -->
             <tr>
                <td colspan="3">
                    <asp:DataGrid ID="Grid" runat="server" Width="100%" PageSize="10" AllowPaging="True" DataKeyField="RowId" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged"                                   OnDeleteCommand="Grid_DeleteCommand" OnEditCommand="Grid_EditCommand" >
