...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr><td width="100%"> 
    <fieldset><legend>Add/Update Employee Education</legend>
      <table width="100%" border="0" class="Partgrayblock">
            ...
            <tr  align=center>
			    <td  valign="middle" colspan="3"><center><asp:button id=EmpEdu_Save runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Save"></asp:button>
