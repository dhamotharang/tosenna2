...
<asp:PlaceHolder id=EditArea Runat="server" visible="true">
 <tr width="100%">
		<td class="colheader">View Employee Information</td>
</tr>
<tr>
  <td>
...
<tr><td width="100%">
 <asp:PlaceHolder id="DependentTab" Runat="server" visible="false">
     <fieldset><legend>Dependents Information</legend>
        <table width="100%" border="0" class="Partgrayblock">      
            <!-- Datagrid for dependents -->
            <tr>
                <td colspan="4">
                        <asp:DataGrid ID="DPGrid" runat="server" Width="100%" PageSize="5" AllowPaging="True" DataKeyField="dependentID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="DPGrid_PageIndexChanged">                                       
                          <Columns>
    ...
    <fieldset><legend>Emergency Contacts</legend>
      <table width="100%" border="0" class="Partgrayblock">
            ...
            <!-- Emergency Contact Grid -->
             <tr>
                <td colspan="4">
                    <asp:DataGrid ID="ECGrid" runat="server" Width="100%" PageSize="5" AllowPaging="True" DataKeyField="EContactID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="ECGrid_PageIndexChanged">                               
                      <Columns>
  ...
  <fieldset><legend>Current Year Compensation(YTD)</legend>
        <table width="100%" border="0" class="Partgrayblock">
            ...
            <!-- Benefits Grid -->
             <tr>
                <td colspan="4">
                    <asp:DataGrid ID="BTGrid" runat="server" Width="100%" PageSize="10" AllowPaging="True" DataKeyField="PayComponentID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"  
                    Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>My Monthly Compensation/Benefit Details</td></tr></table>' CaptionAlign="Top">                                  
                      <Columns>
            ...
            <!-- Deductions Grid -->
             <tr>
                <td colspan="4">
                    <asp:DataGrid ID="DedGrid" runat="server" Width="100%" PageSize="10" AllowPaging="True" DataKeyField="DeductionID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"  
                    Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>My Standard/Reoccuring Monthly Deduction Details</td></tr></table>' CaptionAlign="Top">                                  
                      <Columns>
...
<tr><td width="100%">
 <asp:PlaceHolder id="OtherBenefitsTab" Runat="server" visible="false">
  <fieldset><legend>Leave Balance</legend>
        <table width="100%" border="0" class="Partgrayblock">
