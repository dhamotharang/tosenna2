<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CurrentPayrollMonthUnPaidLeaveReport.aspx.cs" Inherits="SchoolNet.CurrentPayrollMonthUnPaidLeaveReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>Current Payroll Month Unpaid Leave Report</center></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr><td class="mainheadtxt" ><asp:textbox id=Payroll_Date cssclass="monthPicker1" TabIndex=1 Maxlength="20" runat="server"></asp:textbox>		    
