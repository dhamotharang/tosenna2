<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayrollDashBoard.aspx.cs" Inherits="SchoolNet.PayrollDashBoard" %>
...
<tr>
          ...
          <table width="100%">
             ...
             <tr>            
                 <td width="100%" valign="top">
                        <asp:DataGrid ID="Grid1" Width="100%" runat="server" PageSize="10" AllowPaging="True" DataKeyField="DivisionName" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnItemDataBound="Grid1_ItemDataBound" OnPageIndexChanged="Grid1_PageIndexChanged">                        
                              <Columns>
          ...
          <td width="40%" valign="top">
           ...
           <div id="scrollable_content">          
            <table width="100%">
             ...
             <tr>            
                 <td width="100%" valign="top">
                        <asp:DataGrid ID="Grid2" Width="100%" runat="server" PageSize="10" AllowPaging="True" DataKeyField="CompanyCode" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnItemDataBound="Grid2_ItemDataBound" OnPageIndexChanged="Grid2_PageIndexChanged">                        
                              <Columns>
                                    <asp:BoundColumn HeaderText="YYYY-MM" DataField="Year-Month" ItemStyle-Width="8%"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderText="Company Code" DataField="CompanyCode" ItemStyle-Width="12%"></asp:BoundColumn>
   ...
   <tr><td colspan="2">&nbsp;</td></tr>      
  <tr width="100%">
        <td width="50%" valign="top"><cc1:Chart ID="EmpListChart1" runat="server" Width="540px" Height="250px" ChartType="PieChart" LineColor="Olive" AlternateText="Employee Count Breakdown By Business Unit/Dept." ChartTitle="Employee Count Breakdown By Business Unit/Dept" ImageAlign="Left"></cc1:Chart></td>
        <td width="50%" valign="top"><cc1:Chart ID="EmpListChart2" runat="server" Width="540px" Height="250px" ChartType="PieChart" LineColor=Crimson AlternateText="Employee Count Breakdown By Location" ChartTitle="Employee Count Breakdown By Country" ImageAlign="Left"></cc1:Chart></td>
 </tr>
