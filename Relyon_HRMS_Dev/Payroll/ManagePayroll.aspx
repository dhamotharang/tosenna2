...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>Employee Payroll Management</center></td>
	</tr>	
	<tr>
		<td>
  ...
  <tr width="100%">
    <td>
        <asp:DataGrid ID="Grid" runat="server" PageSize="10" Width="100%" AllowPaging="True" AllowSorting="True"  DataKeyField="EmpId" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged"                      OnEditCommand="Grid_EditCommand" OnSorting="Grid_SortCommand">
                      <Columns>
...
<asp:PlaceHolder id=EditArea Runat="server" visible="false">
 <tr width="100%">
		<td class="colheader">Review and Reconcilation of Employee Payroll Information</td>
</tr>
<tr>
  <td>
    <table width="100%" border="0" class="Partgrayblock">
...
<asp:placeholder id="Tab1_Pane" runat="server" Visible=false>
    <legend>Review and  Reconciliation of Monthly Payroll</legend>
        <table width="100%" border="0" class="Partgrayblock">
            ...
            <tr>
	         ...
	         <asp:placeholder id="Paycomponents" visible=false runat="server">   
		      <tr><td colspan="3" class="mainheadtxt4" valign="top">Standard Monthly Benefits and Deductions</td>
            ...
            <tr  align=center>
			    <td  valign="middle" colspan="4">
			        <center>
			                <asp:button id=Payroll_Save runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Save Monthly Payroll" OnClientClick="return confirm('Are you sure you want to save the monthly payroll data?');"></asp:button>
