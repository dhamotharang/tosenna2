...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>Preview Monthly Payroll</center></td>
	</tr>	
	<tr>
		<td>
    	   ...
    	   <tr class="PartWhite" align=center>
			    <td  valign="middle" colspan="4"><center><asp:button id=Preview runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Preview Monthly Payroll" OnClientClick="return confirm('Payroll Preview allows you to validate and make corrections to the monthly payroll data entered before monthly payroll is run.Are you sure you want to run the monthly payroll preview now?');"></asp:button></center></td>
		   </tr>	
	    </table>
	   </td>						
	</tr>
