<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyPayrollDetailReport.aspx.cs" Inherits="SchoolNet.MonthlyPayrollDetailReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>Monthly Detailed Payroll Report</center></td>
	</tr>	
	<tr>
		<td>
