<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyPayrollSummary.aspx.cs" Inherits="SchoolNet.MonthlyPayrollSummary" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>Monthly Payroll Summary Report</center></td>
	</tr>	
	<tr>
		<td>
