...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>Process Monthly Payroll - Batch Process</center></td>
	</tr>	
	<tr>
		<td>
    	   ...
    	   <tr class="PartWhite" align=center>
			    <td  valign="middle" colspan="4"><center><asp:button id=Submit runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Process Monthly Payroll" OnClientClick="return confirm('Please note that this is a batch process for monthly payroll preparation for all employees in the selected Business Unit/Location.You should run this only after all adhoc payroll related tranactions for current payroll month are entered into the system.Are you sure you want to run this now?');"></asp:button></center></td>
		   </tr>	
	    </table>
	   </td>						
	</tr>
