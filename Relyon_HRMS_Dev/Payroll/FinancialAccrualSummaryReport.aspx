<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinancialAccrualSummaryReport.aspx.cs" Inherits="SchoolNet.FinancialAccrualSummaryReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><center>YTD Financial Accrual Summary Report</center></td>
	</tr>	
	<tr>
		<td>
    	   ...
    	   <tr class="PartWhite" align=center>
			    <td  valign="middle" colspan="4"><center><asp:button id=Preview runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Export" OnClientClick="this.disabled = true; this.value = 'Exporting Now.Do not Click Export Again..';" UseSubmitBehavior="false"></asp:button></center></td>
		   </tr>	
	    </table>
	   </td>						
	</tr>
