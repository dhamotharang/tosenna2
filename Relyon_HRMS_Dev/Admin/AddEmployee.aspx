...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <fieldset><Legend>Add New Employee Information</Legend>		
	  <table width="100%" border="0" class="Partgrayblock">    
            ...
            <tr align=center>
			    <td  valign="middle" colspan="4"><center><asp:button id=Save_Employee TabIndex = 20 runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Save"></asp:button>
