<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Skills.aspx.cs" Inherits="SchoolNet.Skills" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr>
  <td width=100%>
  <asp:DataGrid ID="Grid" runat="server" Width="100%" PageSize="15"  AllowPaging="True" AllowSorting="True" DataKeyField="SkillID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" onPageIndexChanged="Grid_PageIndexChanged" OnCancelCommand="Grid_CancelCommand"
                OnDeleteCommand="Grid_DeleteCommand" OnEditCommand="Grid_EditCommand" OnUpdateCommand="Grid_UpdateCommand"
                Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>Skills Code List</td></tr></table>' CaptionAlign="Top">
              <Columns>
                    <asp:BoundColumn HeaderText="Skill Name" DataField="SkillName" ItemStyle-Width="75%" SortExpression="SkillName"></asp:BoundColumn>
...
<!--   Placeholder 2: Area to allow new add, edit and delete  -->
 ...
 <ASP:PlaceHolder id="ManageCRUD" Runat="server" Visible="false">
    <TR width="100%">
		<td colspan="2"><center>Manage Skills Information</center></td>
		<table width="100%" border="0" class="Partgrayblock">
		<tr>
			<td class="mainheadtxt">Skill Name</td>
		...
		<tr>
			<td class="mainheadtxt"><asp:textbox id=SkillName  Maxlength="50" runat="server"></asp:textbox></td>
