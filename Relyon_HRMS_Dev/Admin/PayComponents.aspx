...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr><td width="100%"> 
    <fieldset><legend>Define Pay and Allowance Components</legend>
         ...
         <!-- Benefits Grid -->
             <tr>
                <td colspan="4">
                    ...
                    Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>Employee Pay/Allowance Components List</td></tr></table>' CaptionAlign="Top">                                  
                      <Columns>
