...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr><td width="100%"> 
    <fieldset><legend>Leave Period Definition</legend>
      <table width="100%" border="0" class="Partgrayblock">
		 ...
		 <tr>
		  ...
		  <tr>
           ...
           <tr><td  valign="middle" colspan="4"><center><asp:button id="LeaveWeek_Save" runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Save"></asp:button></center></td></tr>	
