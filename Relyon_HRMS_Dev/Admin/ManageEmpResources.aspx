...
<asp:PlaceHolder id=EditArea Runat="server" visible="true">
 <tr width="100%">
		<td class="colheader">Manage Employee Resources</td>
</tr>
<!--    Start: Tab 1 -->
<tr><td width="100%">
 <asp:PlaceHolder id="EmployeeDocumentsTab" Runat="server" visible="true">
  <fieldset><legend>Employee Resources and HR Policy Documents</legend>
        <table width="100%" border="0" class="Partgrayblock">
           ...
           <tr>
            ...
            <tr  align=center>
			    <td  valign="middle" colspan="4"><center><asp:button id=Doc_Upload runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Upload Document"></asp:button></center></td>
            </tr>	
            <tr>
