<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Incentives.aspx.cs" Inherits="SchoolNet.Incentives" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 <master:content id="formData" runat="server" height="100%" width="100%">
 <table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
 <asp:PlaceHolder id="PayComponentTab" Runat="server" visible="true">
 <tr><td width="100%"> 
    <fieldset><legend>Define Incentives Components</legend>
         ...
         <!-- Benefits Grid -->
             <tr>
                <td colspan="4">
                    ...
                    Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>Employee Incentive Components List</td></tr></table>' CaptionAlign="Top">                                  
                      <Columns>
                            <asp:BoundColumn HeaderText="Incentive Component Name" DataField="PayComponentName" ItemStyle-Width="18%"></asp:BoundColumn>
		    ...
		    <tr>
			    <td class="mainheadtxt">Component Name&nbsp;<small>(Example: Sign on Bonus)</small><font color="red">*</font></td>
