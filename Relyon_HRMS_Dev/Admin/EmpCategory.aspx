...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="ManageCRUD" Runat="server" Visible="true">
   <ASP:PlaceHolder id="ManageCRUDEntry" Runat="server" Visible="false">
    <tr width="100%">
		<td class="colheader"><center>Manage Employee Category Information</center></td>
	</tr>
	...
	<tr>
	  <td> 
		...
		<tr>
			...
			<td class="mainheadtxt"><asp:textbox id=EmpCategoryName  Maxlength="50" Width="220px" runat="server"></asp:textbox></td>
 ...
 <tr>
  <td width=100%>
          <asp:DataGrid ID="Grid" runat="server" Width="100%" PageSize="15"  AllowPaging="True"  DataKeyField="EmpCategoryID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" onPageIndexChanged="Grid_PageIndexChanged" 
                         OnEditCommand="Grid_EditCommand" Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>Employee Category List</td></tr></table>' CaptionAlign="Top">
                      <Columns>
