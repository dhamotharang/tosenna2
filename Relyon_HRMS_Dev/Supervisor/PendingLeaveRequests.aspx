...
<tr><td width="100%"> 
   <asp:PlaceHolder id="Tab3_Pane" Runat="server" visible="true">
    <fieldset><legend>Pending Leave Requests Inbox</legend>
      <table width="100%" border="0" class="Partgrayblock">              
            ...
            <tr  align=center>
			    <td  valign="middle" colspan="4"><center><asp:button id=Tab3_Approve runat="server" BorderStyle="Ridge" CausesValidation="True" CssClass="button" BorderWidth="1px" Text="Submit" OnClientClick="this.disabled = true; this.value = 'Submitting Now.Do not Click Submit Again..';" UseSubmitBehavior="false"></asp:button>
            ...
            <!--  Grid -->
             <tr width="100%">
                <td colspan="4">
                    <asp:DataGrid ID="ALGrid" runat="server" Width="100%" PageSize="15" AllowPaging="True" DataKeyField="LeaveRequestID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="ALGrid_PageIndexChanged"                                    OnEditCommand="ALGrid_EditCommand" >
