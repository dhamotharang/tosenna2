<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPayStub.aspx.cs" Inherits="SchoolNet.ViewPayStub" %>
		    ...
		    <tr bgcolor="lightgray">
             ...
             <tr>
		       ...
		       <td colspan="4">
   		     ...
   		     <tr><td colspan="4"><hr /></td></tr>  
             <tr>
                 <td colspan="4" class="mainheadtxt4" align="Left"><small>Note:System Generated Electronic Pay Slip and requires no signature.</small></td>
            </tr>                    
	     </table>
   </td>
</tr>
...
<asp:placeholder id="printbutton" runat="server" visible=false>
    ...
    <center><input type="button" value="Print Pay Slip"  OnClick="getPrint('table1')";></center>
    </td></tr>
</asp:placeholder>   
</asp:placeholder>            
<tr class="PartBrown" >
