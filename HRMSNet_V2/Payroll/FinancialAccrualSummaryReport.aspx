...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">YTD Financial Accrual Summary Report</span></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr><td class="mainheadtxt" ><asp:textbox id=Pay_Year cssclass="date-picker-year textfield" TabIndex=1 Maxlength="20" runat="server"></asp:textbox>		    
