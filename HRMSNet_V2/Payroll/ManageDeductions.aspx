...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Manage Reoccuring Deductions</span></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr>
			    <td class="mainheadtxt"><asp:textbox id=empName  Maxlength="50" CssClass="textfield" width="180px" runat="server"></asp:textbox></td>
			    <td class="mainheadtxt"><asp:textbox id=empID  Maxlength="30" CssClass="textfield" runat="server"></asp:textbox></td>
			    <td class="mainheadtxt"><asp:textbox id=mgrName  Maxlength="50" CssClass="textfield" width="180px" runat="server"></asp:textbox></td>
  ...
  <tr width="100%">
    <td>
        <asp:DataGrid ID="Grid" runat="server" Width="100%" PageSize="15" AllowPaging="True" AllowSorting="True" DataKeyField="EmpId" AutoGenerateColumns="False" CellPadding="4" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged"                      OnEditCommand="Grid_EditCommand" OnSorting="Grid_SortCommand">
                      <Columns>
...
<asp:PlaceHolder id=EditArea Runat="server" visible="false">
 <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee Standard/Reoccuring Deductions</span></td>
</tr>
<tr>
  <td>
    <table width="100%" border="0" class="Partgrayblock">
...
<asp:placeholder id="Tab2_Pane" runat="server" Visible=false>
        ...
        <table width="100%" border="0" class="Partgrayblock">
            <!-- Benefits Grid -->
            <td colspan="5"><span class="maintitledesign">Manage Deductions</span></td>
             <tr>
                <td colspan="5">
                    <asp:DataGrid ID="Tab2Grid"  CssClass="Tabular2" runat="server" Width="100%" PageSize="10" AllowPaging="True" DataKeyField="DeductionID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="Tab2Grid_PageIndexChanged"  OnDeleteCommand="Tab2Grid_DeleteCommand" OnEditCommand="Tab2Grid_EditCommand" 
		    ...
		    <tr>
                ...
                <td class="mainheadtxt"><asp:textbox id=Tab2_RepaymentStartDate cssclass="monthPicker textfield" TabIndex=4 Maxlength="20" runat="server"></asp:textbox></td>
			...
			<center>
             ...
             <tr>
                <td colspan="5" align=center><asp:label id="Tab2_Message" runat="server" visible=false />&nbsp;
