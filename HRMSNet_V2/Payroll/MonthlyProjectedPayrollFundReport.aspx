<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyProjectedPayrollFundReport.aspx.cs" Inherits="SchoolNet.MonthlyProjectedPayrollFundReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Projected Monthly Payroll Fund Report</span></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr><td class="mainheadtxt" ><asp:textbox id=Payroll_Date cssclass="monthPicker textfield" TabIndex=1 Maxlength="20" runat="server"></asp:textbox>		    
			...
			<tr>
			  	<td colspan="1" class="validationtxt"><asp:RequiredFieldValidator runat=server ControlToValidate=Payroll_Date  ErrorMessage="Select Month/Year to prepare project payroll fund report." /></td>
