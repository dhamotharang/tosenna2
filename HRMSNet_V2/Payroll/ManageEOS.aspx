...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee End of Service(EOS) Management</span></td>
	</tr>	
...
<asp:PlaceHolder id=EditArea Runat="server" visible="false">
 <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Review and Reconcilation of End of Service Statement</span></td>
</tr>
<tr>
  <td>
...
<asp:placeholder id="Tab1_Pane" runat="server" Visible=false>
        ...
        <table width="100%" border="0" class="Partgrayblock">
            <tr><td colspan="4"><span class="maintitledesign">Review and  Reconciliation of End of Service Settlement</span></td></tr>
            <tr><td colspan="4">&nbsp;</td></tr>
            <tr>
		        <td class="mainheadtxt">Select Month/Year<font color=red>*</font></td>   
		        <td class="mainheadtxt" >
                    <asp:textbox id=Payroll_Date cssclass="monthPicker2" TabIndex=1 Maxlength="20" runat="server"></asp:textbox>&nbsp;&nbsp;
          ...
          <asp:placeholder id="Paycomponents" visible=false runat="server">   		    
           <tr><td colspan="4" class="HomeTitles">Employment Details</td></tr>    
            <tr>
		    ...
		    <tr>
             ...
             <tr><td colspan="4">&nbsp;</td></tr>
		      ...
		      <tr><td colspan="3" class="HomeTitles" valign="top">Standard Monthly Benefits and Deductions(Prorated based on date of leaving).</td>
		           <td align="right" class="validationtxt HomeTitles" valign="top"><asp:label id="Tab1_CurrenyLabel1" runat="server"></asp:label></td>
		      </tr>
		    
		        <!-- Pay and Allowance Grid -->
             <tr>
                <td colspan="4">
                    <asp:DataGrid ID="Tab1Grid" CssClass="Tabular2" Width="100%" runat="server" PageSize="20" AllowPaging="false" DataKeyField="PayComponentID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">                                  
                      <Columns>
            ...
            <tr><td colspan="4">&nbsp;</td></tr>
            <tr><td colspan="4" class="HomeTitles">Adhoc Monthly Payroll Transactions</td></tr>                         
             <tr>
                <td colspan="4">
		    ...
		    <tr><td colspan="4">&nbsp;</td></tr>
            <tr><td colspan="4" class="HomeTitles">Monthly Payroll UnPaid Leave Information</td></tr>                  
            <tr>
		    ...
		    <tr><td colspan="4">&nbsp;</td></tr>
            <tr><td colspan="4" class="HomeTitles">Employee Bank Information</td></tr> 
		    <tr>
            ...
            <tr>
		     ...
		     <tr><td colspan="4">&nbsp;</td></tr>
		     <tr><td colspan="4" class="HomeTitles">Payroll Comments</td></tr>                              
		     <tr>
