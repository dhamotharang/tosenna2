 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
	...
	<tr>
		<td>
            ...
            <td  colspan="4">
            <center>
            <asp:button id=Submit runat="server" CausesValidation="True" CssClass="Button ExportButton" Text="Extract"  OnClientClick="return confirm('Please note that this is a one time batch process for monthly payroll.You must have processed monthly payroll process first before you generate WPS.Are you sure you want to run this?');"></asp:button>
            </center>
            </td>
            </tr>	
		   <tr><td colspan="4">&nbsp;</td></tr>
