...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">View Employee Payroll History</span></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr>
			    ...
			    <td class="mainheadtxt"><asp:textbox id=empID CssClass="textfield" Maxlength="30" runat="server"></asp:textbox></td>
  ...
  <tr width="100%">
    <td>
        <asp:DataGrid ID="Grid" runat="server" PageSize="15" Width="100%" AllowPaging="True" AllowSorting="True"  DataKeyField="EmpId" AutoGenerateColumns="False" CellPadding="4" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged"                      OnEditCommand="Grid_EditCommand" OnSorting="Grid_SortCommand">
                      <Columns>
...
<asp:PlaceHolder id=EditArea Runat="server" visible="false">
 <tr width="100%">
		<td class="colheader"><span class="maintitledesign">View Payroll History</span></td>
</tr>
<tr>
  <td>
    <table width="100%" border="0" class="Partgrayblock">
...
<asp:placeholder id="Tab1_Pane" runat="server" Visible=false>
        <table width="100%" border="0" class="Partgrayblock">
            <tr width="100%"><td colspan="4"><span class="maintitledesign">View Monthly Payroll</span></td></tr>
            <tr><td colspan="4">&nbsp;</td></tr>
            <tr>
		        <td class="mainheadtxt">Select Month/Year<font color=red>*</font></td>   
		        <td class="mainheadtxt" ><asp:textbox id=Payroll_Date cssclass="monthPicker1 textfield" TabIndex=1 Maxlength="20" runat="server"></asp:textbox>		    
		          &nbsp;&nbsp;
                ...
                <td colspan="2" class="mainheadtxt" align=center>     
		            Payroll Status:&nbsp;<asp:dropdownlist id="Tab1_PayrollStatusType" disabled=true AutoPostBack=false runat="server" TabIndex=21 Width="110px" CssClass="textfield"></asp:dropdownlist>     
		       </td>
		   </tr> 
	         ...
	         <asp:placeholder id="Paycomponents" visible=false runat="server">  
              <tr>
                <td class="mainheadtxt" colspan="4" align="right">                             
                    <asp:HyperLink ID="WPSDownloadLink" runat="server" visible=false></asp:HyperLink>		
                </td>             
		     </tr>
	         
	         <tr><td colspan="4"><hr /></td></tr> 
		      <tr class="HomeTitles"><td colspan="3" class="mainheadtxt" valign="top">Pay Components(Allowances and Deductions)</td>
            ...
            <tr class="HomeTitles"><td colspan="4" class="mainheadtxt">Monthly Payroll UnPaid Leave Information</td></tr> 
            <tr><td colspan="4">&nbsp;</td></tr>                        
            <tr>
		    ...
		    <tr><td colspan="4">&nbsp;</td></tr>
            <tr class="HomeTitles"><td colspan="4" class="mainheadtxt">Employee Bank Information</td></tr> 
            <tr><td colspan="4">&nbsp;</td></tr>                                                     
		    <tr>
            ...
            <tr>
		     ...
		     <tr><td colspan="4">&nbsp;</td>
		     <tr class="HomeTitles"><td colspan="4" class="mainheadtxt">Payroll Note</td></tr>                              
		     <tr>
