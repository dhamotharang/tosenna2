<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeBenefitHistoryReport.aspx.cs" Inherits="SchoolNet.EmployeeBenefitHistoryReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employees Benefit History Data Report </center></td>
	</tr>	
	<tr>
		<td>
