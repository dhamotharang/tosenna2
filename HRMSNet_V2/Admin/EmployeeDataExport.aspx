<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeDataExport.aspx.cs" Inherits="SchoolNet.EmployeeDataExport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee Main Data Export</span></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr>
			 ...
			 &nbsp;&nbsp;<asp:button id=Export runat="server" CausesValidation="True" CssClass="Button ExportButton" Text="Export"></asp:button></asp:button></td>
		 </tr>				     
