...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <table  border="0" cellspacing="0" cellpadding="0" width=100% height="100%">
  <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee Status Master Data</span></td>
	</tr>	
 <ASP:PlaceHolder id="ManageCRUD" Runat="server" Visible="True">
  ...
  <td  colspan="4" width=100%>
          <asp:DataGrid ID="Grid" CssClass="Tabular2" Width="100%" runat="server" PageSize="15"  AllowPaging="True"  DataKeyField="EmpStatusID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" onPageIndexChanged="Grid_PageIndexChanged" 
