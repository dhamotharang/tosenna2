...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr width="100%">
		<td class="colheader"><span class="maintitledesign">End of Service(EOS) Gratuity Rules</span></td>
	</tr>	
 ...
 <tr><td width="100%"> 
      <table width="100%" border="0" class="Partgrayblock">
         <!-- Benefits Grid -->
			...
			<td  colspan="4">
			<center>
			    <asp:button id=EOS_Save runat="server" CausesValidation="True" CssClass="Button SaveButton" Text="Save"></asp:button>
			    &nbsp;&nbsp;&nbsp;
            ...
            <tr><td colspan="4"><hr /></td></tr>
             ...
             <tr>
                <td colspan="4">
                    <asp:DataGrid ID="Grid" CssClass="Tabular2" runat="server" Width="100%" PageSize="10" AllowPaging="True" DataKeyField="GratuityRuleId" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged"  OnDeleteCommand="Grid_DeleteCommand" OnEditCommand="Grid_EditCommand" 
