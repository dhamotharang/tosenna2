...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <tr width="100%">
		<td class="colheader"><span class="maintitledesign">User Accounts Management</span></td>
	</tr>	
 ...
 <tr><td width="100%"> 
      <table width="100%" border="0" class="Partgrayblock">
        ...
        <asp:PlaceHolder id="AddAccount" runat="server" visible="true">
			...
			<td  colspan="4">
			<center>
			    <asp:button id=PortalAcct_Save runat="server" CausesValidation="True" CssClass="Button SaveButton" Text="Save"></asp:button>
			    &nbsp;&nbsp;&nbsp;
			...
			<td  colspan="4">
			<center>
			    <asp:button id=PortalEdit_Save runat="server" CausesValidation="True" CssClass="Button SaveButton" Text="Save"></asp:button>
			    &nbsp;&nbsp;&nbsp;
			    <asp:button id=Edit_Reset runat="server" CausesValidation="false" CssClass="Button ResetButton" Text="Reset"></asp:button>
			</center>
			</td>
            </tr>
            <tr>
             ...
             <tr>
                <td colspan="4" >
                    <asp:DataGrid ID="Grid" CssClass="Tabular2" runat="server" Width="100%" PageSize="10" AllowSorting="True"  AllowPaging="True" DataKeyField="EmpId" AutoGenerateColumns="False" CellPadding="4" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged"                                   OnDeleteCommand="Grid_DeleteCommand" OnEditCommand="Grid_EditCommand" OnSorting="Grid_SortCommand" >
                      ...
                      <Columns>
                            ...
                            <asp:BoundColumn HeaderText="Employee Name" DataField="Emp_Name"  SortExpression="Emp_Name" ItemStyle-Width="20%"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="User Name" DataField="UserName" SortExpression="UserName" ItemStyle-Width="21%"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="Role Name" DataField="RoleName" SortExpression="RoleName"  ItemStyle-Width="10%"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="Business Unit" DataField="DivisionName" SortExpression="DivisionName" ItemStyle-Width="20%"></asp:BoundColumn>
                            ...
                            <asp:TemplateColumn visible=false HeaderText="" ItemStyle-Width="4%">
                                   <ItemTemplate> 
