<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeBenefitDataChangeAuditReport.aspx.cs" Inherits="SchoolNet.EmployeeBenefitDataChangeAuditReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employees Benefit Data Change Audit Report </span></td>
	</tr>	
	<tr>
		<td>
