...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee Leave Management</span></td>
	</tr>
...
<tr><td width="100%">
 <asp:PlaceHolder id="Tab1_Pane" Runat="server" visible="false">
        ...
        <table width="100%" border="0" class="Partgrayblock">
            <tr><td colspan="4"><span class="maintitledesign">Annual Leave Entitlements/Balances</span></td></tr>               
            <tr><td colspan="4">&nbsp;</td></tr>
 	        <tr>
			...
			<td  colspan="4">
			<center>
			    <asp:button id=Entitlement_Save runat="server" CausesValidation="True" CssClass="Button SaveButton" Text="Save"></asp:button>
			    &nbsp;&nbsp;&nbsp;
			    <asp:button id=Entitlement_Cancel runat="server" CausesValidation="false" CssClass="Button ResetButton" Text="Reset"></asp:button>
			</center>
			</td>
		    </tr>		    
            ...
            <tr><td colspan="4"><hr /></td></tr>
             ...
             <tr>
                <td colspan="4">
                    <asp:DataGrid ID="EGrid" class="Tabular2" runat="server" Width="100%" PageSize="5" AllowPaging="True" DataKeyField="EntitlementID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="EGrid_PageIndexChanged"                                    OnDeleteCommand="EGrid_DeleteCommand" OnEditCommand="EGrid_EditCommand" >                                   
                      <Columns>
...
<tr><td width="100%"> 
   <asp:PlaceHolder id="Tab2_Pane" Runat="server" visible="false">
      ...
      <table width="100%" border="0" class="Partgrayblock"> 
            <tr><td colspan="4"><span class="maintitledesign">Past Leave History</span></td></tr>               
		    <tr><td colspan="4">&nbsp;</td></tr>
		    <tr>
...
<tr><td width="100%"> 
   <asp:PlaceHolder id="Tab3_Pane" Runat="server" visible="false">
      ...
      <table width="100%" border="0" class="Partgrayblock"> 
      <tr><td colspan="4"><span class="maintitledesign">Pending Leave Requests</span></td></tr>               
		    <tr><td colspan="4">&nbsp;</td></tr>
		    <tr>
        	    <td class="mainheadtxt">Leave Start Date</td>
		        <td class="mainheadtxt">Leave End Date</td>
            ...
            <!-- Emergency Contact Grid -->
             <tr width="100%">
                <td colspan="4">
                    <asp:DataGrid ID="ALGrid" class="Tabular2" runat="server" Width="100%" PageSize="12" AllowPaging="True" DataKeyField="LeaveRequestID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="ALGrid_PageIndexChanged"                                    OnEditCommand="ALGrid_EditCommand" >
