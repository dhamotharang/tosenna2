<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CurrentYearNewHiresReport.aspx.cs" Inherits="SchoolNet.CurrentYearNewHiresReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">New Hires Report - Current Year</span></td>
	</tr>	
	<tr>
		<td>
