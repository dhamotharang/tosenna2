<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisaSponsor.aspx.cs" Inherits="SchoolNet.VisaSponsor" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id=EmpCatGrid Runat="server">
  <tr>
  <td width=100%>
  <asp:DataGrid ID="Grid" runat="server" Width="100%" PageSize="10"  AllowPaging="True" AllowSorting="True" DataKeyField="VisaSponsorID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" onPageIndexChanged="Grid_PageIndexChanged" OnCancelCommand="Grid_CancelCommand"
                OnDeleteCommand="Grid_DeleteCommand" OnEditCommand="Grid_EditCommand" OnUpdateCommand="Grid_UpdateCommand"
                Caption='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td class=colheader>Visa Sponsors List</td></tr></table>' CaptionAlign="Top">
              <Columns>
                    <asp:BoundColumn HeaderText="Visa Sponsor Name" DataField="SponsorName" ItemStyle-Width="75%" SortExpression="SponsorName"></asp:BoundColumn>
                    <asp:BoundColumn HeaderText="Status" DataField="Status" ItemStyle-Width="25%" SortExpression="Status" ></asp:BoundColumn>
...
<!--   Placeholder 2: Area to allow new add, edit and delete  -->
 ...
 <ASP:PlaceHolder id="ManageCRUD" Runat="server" Visible="false">
    <TR width="100%">
		<td colspan="2"><center>Manage Visa Sponsor Information</center></td>
		<table width="100%" border="0" class="Partgrayblock">
		<tr>
			<td class="mainheadtxt">Sponsor Name</td>
		...
		<tr>
			<td class="mainheadtxt"><asp:textbox id=SponsorName  Maxlength="50" runat="server"></asp:textbox></td>
