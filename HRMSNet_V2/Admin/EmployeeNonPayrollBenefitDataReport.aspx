<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeNonPayrollBenefitDataReport.aspx.cs" Inherits="SchoolNet.EmployeeNonPayrollBenefitDataReport" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employees Non-Payroll Benefit Data Report </span></td>
	</tr>	
	<tr>
		<td>
