...
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="ManageCRUD" Runat="server">
   <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Manage Business Unit Information</span></td>
 </tr>	
 <tr>
	<td>
		...
		<tr>
			...
			<td class="mainheadtxt"><asp:dropdownlist id="SupervisorDDList" cssclass="textfield" TabIndex=3 AutoPostBack=false runat="server" Width="180px" ></asp:dropdownlist></td>
   		    <td class="mainheadtxt"><asp:textbox id=GLCode  Maxlength="50" cssclass="textfield" TabIndex=4 runat="server"></asp:textbox></td>
    	...
    	<tr class="PartButtons" align=center>
          ...
          <tr>
  <td colspan="5">
  <asp:DataGrid ID="Grid" CssClass="Tabular2" runat="server" Width="100%" PageSize="7" AllowPaging="True"  DataKeyField="DivisionID" AutoGenerateColumns="False" CellPadding="4" GridLines="None" OnPageIndexChanged="Grid_PageIndexChanged" 
                 ...
                 <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="" ItemStyle-Width="15%">
                                <ItemTemplate>  
                                     ...
                                     &nbsp;
                                     <asp:ImageButton ImageUrl="~/images/buttons/blue_setting.png" name="Manage Location" commandName="Select" alt="Manage" ToolTip="Manage" CausesValidation="false" runat="server" height="28" width="28" />                                                                
                                </ItemTemplate>
                         </asp:TemplateColumn>
...
<!--  Manage Division Location -->
 <ASP:PlaceHolder id="Managelocation" Runat="server" Visible=false>
   <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Manage Business Unit Country Information</span></td>
 </tr>	
 <tr>
	<td>
     	<table width="100%" border="0" class="Partgrayblock">
        ...
        <tr class="PartButtons" align=center>
			...
			<center>
			    ...
			    &nbsp;&nbsp;&nbsp;
                <asp:button id=Tab2_Back runat="server" CausesValidation="True" CssClass="Button BackButton" Text="Back"></asp:button>
			</center>
			</td>
            </tr>
         ...
         <tr>
  <td colspan="5">
  <asp:DataGrid ID="LGrid" CssClass="Tabular2" runat="server" Width="100%" PageSize="7" AllowPaging="True"  DataKeyField="LocationID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="LGrid_PageIndexChanged" 
...
<!--  Manage Division Location Department-->
 <ASP:PlaceHolder id="ManagelocationDept" Runat="server" Visible=false>
   <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Manage Country Specific Department Information</span></td>
 </tr>	
 <tr>
	<td>
     	<table width="100%" border="0" class="Partgrayblock">
		...
		<tr>
            ...
            <td class="mainheadtxt"><asp:textbox id=Tab3_GLCode  Maxlength="50" cssclass="textfield" TabIndex=5 runat="server"></asp:textbox></td>			                        
        ...
        <tr class="PartButtons" align=center>
			...
			<center>
			    ...
			    &nbsp;&nbsp;&nbsp;
                <asp:button id=Tab3_Back runat="server" CausesValidation="True" CssClass="Button BackButton" Text="Back"></asp:button>
			</center>
			</td>
            </tr>
         ...
         <tr><td colspan="5"><hr /></td></tr>	
          <tr>
  <td colspan="5">
  <asp:DataGrid ID="DGrid" CssClass="Tabular2" runat="server" Width="100%" PageSize="7" AllowPaging="True"  DataKeyField="LocationID" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" onpageindexchanging="DGrid_PageIndexChanged" 
                OnEditCommand="DGrid_EditCommand"  Caption='' CaptionAlign="Top">
