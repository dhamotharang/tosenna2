<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnnualLeaveBalance.aspx.cs" Inherits="SchoolNet.AnnualLeaveBalance" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee Annual Leave Balance Report(Current Year) </span></td>
	</tr>	
	<tr>
		<td>
