<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MissingBenefitData.aspx.cs" Inherits="SchoolNet.MissingBenefitData" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Missing Benefit Data Report </span></td>
	</tr>	
	<tr>
		<td>
