<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MissingLeaveApprovalSetting.aspx.cs" Inherits="SchoolNet.MissingLeaveApprovalSetting" %>
<%@ Register TagPrefix="Master" Namespace="PresentationManager.Web.UI.MasterPages" Assembly="PresentationManager.Web.UI.MasterPages" %>
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Missing Annual Leave Approval Settings Report </span></td>
	</tr>	
	<tr>
		<td>
