...
<table  border="0" cellspacing="0" cellpadding="0" width=100% height="100%">
 ...
 <ASP:PlaceHolder id="EmpSearchBox" Runat="server">
    <tr width="100%">
		<td class="colheader"><span class="maintitledesign">Employee Annual Leave Entitlement (Yearly)</span></td>
	</tr>	
	<tr>
		<td>
		    ...
		    <tr>
   			    <td class="mainheadtxt"><asp:textbox id=Tab1_EmpName cssclass="textfield" Maxlength="50" width="180px" runat="server"></asp:textbox></td>
