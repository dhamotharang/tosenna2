...
namespace DatabaseManager.Data
{
	...
	/// </summary>
		...
		public sealed class DBAccessManager
		{
            ...
            #region RetrievePrivilegedUsersLookupByEmpId
            public static NamedCollection[] RetrievePrivilegedUsersLookupByEmpId(Int32 EmpId)
            {

                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@RequestorID", SqlDbType.Int);
                parameters[0].Value = EmpId;
                return RetrieveCollection("spGetPrivilegedUsers", parameters);
          ...
          #region RetrieveEmployeeListLBX
           ...
           #region RetrieveEntityLocationLookup
            ...
            #endregion
            #region RetrieveOfficeLocationLookupByDivisionID_LocationID
            public static NamedCollection[] RetrieveOfficeLocationLookupByDivisionID_LocationID(Int32 DivisionID, Int32 LocationID)
            {
                SqlParameter[] parameters = new SqlParameter[2];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                return RetrieveCollection("[spGetOfficeLocationLookupByDivisionID_LocationID]", parameters);
            ...
            #region RetrieveEmployeeCountryName
            public static String RetrieveEmployeeCountryName(Int32 EmpId)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spgetEmployeeCountryName", parameters);
            }
            #endregion
           ...
           #region RetrieveEmployeeList_GeneralSearch
            ...
            #endregion
            #region RetrievePayrollDashBoardDataByEmpID
            public static DataSet RetrievePayrollDashBoardDataByEmpID(Int32 RequestorID, Int32 DivisionID, Int32 DivisionLocationID)
            {
                SqlParameter[] parameters = new SqlParameter[3];
                ...
                parameters[2] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[2].Value = DivisionLocationID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetPayrollDashBoardDataByEmpID", parameters);
                return dataSet;
         ...
         #region RetrieveTMDashBoardData_Employee
            ...
            #endregion  
            #region RetrieveMappedUserInfo
            public static DataSet RetrieveMappedUserInfo(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetMappedEmployeeInfo", parameters);
                return dataSet;
            ...
            #endregion 
            #region RetrieveKeyEmpInformation
            public static DataSet RetrieveKeyEmpInformation(String EmployeeID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmployeeID", SqlDbType.VarChar, 30);
                parameters[0].Value = EmployeeID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetEmployeeInformation", parameters);
                return dataSet;
          ...
          public static DataSet RetrieveSalaryCertificateData(Int32 RequestID, Int32 Edit_EmpId)
           {
            ...
            #endregion 
            #region RetrieveEmployeeEOSBenefitInfo
            public static DataSet RetrieveEmployeeEOSBenefitInfo(Int32 EmpId, String MonthYear)
            {
                SqlParameter[] parameters = new SqlParameter[2];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                ...
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetEmployee_EOSBenefit", parameters);
                return dataSet;
            ...
            #region RetrieveEmployeeDetailedMonthlyPayrollSummary
            public static DataSet RetrieveEmployeeDetailedMonthlyPayrollSummary(String Pay_MonthYear, Int32 DivisionID, Int32 DivisionLocationID, Int32 ProcessState, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                parameters[0] = new SqlParameter("@Pay_MonthYear", SqlDbType.VarChar, 30);
                parameters[0].Value = Pay_MonthYear;
                ...
                parameters[3] = new SqlParameter("@ProcessState", SqlDbType.Int);
                parameters[3].Value = ProcessState;
                parameters[4] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[4].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptDetailedPayrollDataReport", parameters);
                return dataSet;
            }
            #endregion 
            
            #region RetrievePostPayrollPaymentCycleSummary
            public static DataSet RetrievePostPayrollPaymentCycleSummary(String Pay_MonthYear, Int32 DivisionID, Int32 DivisionLocationID, Int32 ProcessState, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                parameters[0] = new SqlParameter("@Pay_MonthYear", SqlDbType.VarChar, 30);
                parameters[0].Value = Pay_MonthYear;
                ...
                parameters[4] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[4].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptPaymentCycleReport", parameters);
                return dataSet;
            }
            #endregion 
            ...
            #region RetrieveEmployeeMainData
            public static DataSet RetrieveEmployeeMainData(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch,Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                parameters[1] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[1].Value = DivisionLocationID;
                parameters[2] = new SqlParameter("@OfficeBranch", SqlDbType.VarChar,50);
                parameters[2].Value = OfficeBranch;
                parameters[3] = new SqlParameter("@RequestingEmpId", SqlDbType.Int);
                parameters[3].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptMainEmployeeData", parameters);
                return dataSet;
            ...
            public static DataSet RetrieveNewHiresReport(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
            ...
            public static DataSet RetrieveEmployeeAttritionReport(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
            ...
            #endregion 
            #region RetrieveProjectModuleMonthlyForecastTimeSheetData
            public static DataSet RetrieveProjectModuleMonthlyForecastTimeSheetData(Int32 DivisionID, Int32 DivisionLocationID, String ReportMonthYear)
            {
                SqlParameter[] parameters = new SqlParameter[3];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                parameters[2] = new SqlParameter("@ReportMonthYear", SqlDbType.VarChar, 20);
                parameters[2].Value = ReportMonthYear;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptProjectModuleUtilzation_MonthlyForecast", parameters);
                return dataSet;
            }
      #endregion 
            ...
            #endregion 
            #region RetrieveProjectModuleTimeSheetData
            public static DataSet RetrieveProjectModuleTimeSheetData(Int32 DivisionID, Int32 DivisionLocationID, String StartDate, String EndDate, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                parameters[4] = new SqlParameter("@RequestingEmpId", SqlDbType.Int);
                parameters[4].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptProjectModuleUtilization", parameters);
                return dataSet;
            }
           #endregion 
            ...
            #region RetrieveSystemAccessList
            public static DataSet RetrieveSystemAccessList(Int32 DivisionID, Int32 DivisionLocationID, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[3];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                parameters[1] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[1].Value = DivisionLocationID;
                parameters[2] = new SqlParameter("@Requestor_ID", SqlDbType.Int);
                parameters[2].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptGetUserAccessRights", parameters);
                return dataSet;
            }
            #endregion 
           ...
           #endregion 
            #region RetrieveLeaveData
            public static DataSet RetrieveLeaveData(Int32 LeaveTypeID, Int32 DivisionID, Int32 DivisionLocationID,String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                parameters[0] = new SqlParameter("@LeaveTypeID", SqlDbType.Int);
                parameters[0].Value = LeaveTypeID;
                ...
                parameters[2] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[2].Value = DivisionLocationID;
                parameters[3] = new SqlParameter("@OfficeBranch", SqlDbType.VarChar,50);
                parameters[3].Value = OfficeBranch;
                parameters[4] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[4].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptCurrentPeriodLeaveRequests", parameters);
                return dataSet;
            ...
            #region RetrieveLeaveBalanceData
            public static DataSet RetrieveLeaveBalanceData(Int32 LeaveTypeID, Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                parameters[0] = new SqlParameter("@LeaveTypeID", SqlDbType.Int);
                parameters[0].Value = LeaveTypeID;
            ...
            public static DataSet RetrieveBenefitData(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch,Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
            ...
            #region RetrieveNonPayrollBenefitData
            public static DataSet RetrieveNonPayrollBenefitData(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                parameters[3] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[3].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptGetEmployeeNonpayrollBenefitData", parameters);
                return dataSet;
            }
            #endregion
            #region RetrieveNonPayrollIncentivesData
            public static DataSet RetrieveNonPayrollIncentivesData(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                parameters[3] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[3].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptGetEmployeeNonpayrollIncentivesData", parameters);
                return dataSet;
            }
            #endregion


            #region RetrieveBenefitChangeHistoryData
            public static DataSet RetrieveBenefitChangeHistoryData(Int32 DivisionID, Int32 DivisionLocationID, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[3];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                parameters[2] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[2].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptGetBenefitDataChangeHistory", parameters);
                return dataSet;
            }
           #endregion 

          #region RetrieveBenefitChangeAuditData
          public static DataSet RetrieveBenefitChangeAuditData(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
            ...
            #endregion
            #region RetrieveBenefitHistoryData
            public static DataSet RetrieveBenefitHistoryData(Int32 DivisionID, Int32 DivisionLocationID, String OfficeBranch, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                parameters[0] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[0].Value = DivisionID;
                ...
                parameters[3] = new SqlParameter("@Requestor_EmpId", SqlDbType.Int);
                parameters[3].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptEmployeeBenefitHistoryReport", parameters);
                return dataSet;
            }
            #endregion
            ...
            #endregion 
            #region RetrieveYTDFinancialAccrualSummary
            public static DataSet RetrieveYTDFinancialAccrualSummary(String Pay_Year, Int32 DivisionID, Int32 DivisionLocationID, Int32 ProcessState, Int32 RequestingEmpId)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                parameters[0] = new SqlParameter("@Pay_Year", SqlDbType.VarChar, 15);
                parameters[0].Value = Pay_Year;
                ...
                parameters[4] = new SqlParameter("@RequestingEmpId", SqlDbType.Int);
                parameters[4].Value = RequestingEmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spRptAnnualFinancialAccrualReport", parameters);
                return dataSet;
            }
            #endregion 
         ...
         //   See the sample method to just execute but no need to return data back.
            ...
            public static String AddUpdatePayComponents(Int32 PayComponentID, String PayComponentName, String ShortName, Int32 PayFrequencyID, Int32 PayComponentTypeID,Int32 Status, String AccountCode, String AccountDescription,Int32 EditEmpID)
            {
                ...
                parameters[6] = new SqlParameter("@AccountCode", SqlDbType.VarChar, 30);
                parameters[6].Value = AccountCode;
                parameters[7] = new SqlParameter("@AccountDescription", SqlDbType.VarChar, 100);
                parameters[7].Value = AccountDescription;
                parameters[8] = new SqlParameter("@EditEmpId", SqlDbType.Int);
                parameters[8].Value = EditEmpID;
            ...
            public static String AddUpdateCustomerInformation(Int32 RequestorID, Int32 CustomerID, String CustomerName, String CustomerDescription, String Cust_Addr1, String Cust_Addr2,String Cust_City, String Cust_State, String Cust_Country, String ContactPerson, String CustomerPhone, String CustomerFax, String CustomerEmail)
            {
                ...
                parameters[4] = new SqlParameter("@Cust_Addr1", SqlDbType.VarChar, 150);
                ...
                parameters[7] = new SqlParameter("@Cust_State", SqlDbType.VarChar, 50);
                parameters[7].Value = Cust_State;
                parameters[8] = new SqlParameter("@Cust_Country", SqlDbType.VarChar,50);
                parameters[8].Value = Cust_Country;
            ...
            public static String DeactivateEmployee(String EmployeeID, Int32 RequestorID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeactivateEmployee", parameters);
            }
            #endregion
            #region ReactivateEmployee
            public static DataSet ReactivateEmployee(String EmployeeID, Int32 RequestorID)
            {
                ...
                parameters[1] = new SqlParameter("@RequestorID", SqlDbType.Int);
                parameters[1].Value = RequestorID;                
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spReactivateEmployee", parameters);
                return dataSet;
            }
            #endregion
            ...
            public static DataSet AddUpdateLeaveRequest(Int32 LeaveRequestID, Int32 EmpId, String Leave_StartDate, String Leave_EndDate, Int32 LeaveTypeId, String Comments, Int32 DayType)
            {
                SqlParameter[] parameters = new SqlParameter[7];
                ...
                parameters[6] = new SqlParameter("@DayType", SqlDbType.Int);
                parameters[6].Value = DayType;                            
            ...
            public static String AddUpdateLeaveEntitlement(Int32 EmpId, Int32 EntitlementId, Int32 LeaveTypeId, Int32 LeavePeriodID, Decimal EntitlementDays, Int32 LineMgr_Approval, Int32 DeptHead_Approval, Int32 SecondApproverID, Int32 RequestingEmpID)
            {
                SqlParameter[] parameters = new SqlParameter[9];
                ...
                parameters[4] = new SqlParameter("@Entitlement", SqlDbType.Decimal);
                ...
                parameters[7] = new SqlParameter("@SecondApproverID", SqlDbType.Int);
                parameters[7].Value = SecondApproverID;

                parameters[8] = new SqlParameter("@RequestingEmpID", SqlDbType.Int);
                parameters[8].Value = RequestingEmpID;
         ...
         #endregion
            #region Appprove_LeaveRequest
            public static DataSet Cancel_ApprovedLeaveRequest(Int32 LeaveRequestID, Int32 EmpId, String Approver_Comments, Int32 RequestorID)
            {
                SqlParameter[] parameters = new SqlParameter[4];
                ...
                parameters[3] = new SqlParameter("@RequestorID", SqlDbType.Int);
                parameters[3].Value = RequestorID;

                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spCancel_ApprovedLeaveRequest", parameters);
                return dataSet;
           ...
           #region AddUpdateWorkWeek
            ...
            public static String AddUpdateEmployeeBenefit(Int32 EmpId, Int32 PayComponentID, Decimal Amount, Int32 ChangeType, String EffectiveDate,Int32 EditEmpId)
            {
                ...
                parameters[4] = new SqlParameter("@EffectiveDate", SqlDbType.VarChar,30);
          ...
          #endregion
          #region AddUpdateEmployeeIncentive
            public static String AddUpdateEmployeeIncentive(Int32 EmpId, Int32 PayComponentID, Decimal Amount, Int32 ChangeType, Int32 EditEmpId)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spAddUpdateEmployee_Incentive", parameters);
            }
            #endregion
            #region AddUpdateEmployeeNonPayrollBenefit
            public static String AddUpdateEmployeeNonPayrollBenefit(Int32 EmpId, Int32 PayComponentID, Decimal Amount, Int32 ChangeType, Int32 EditEmpId)
            {
                ...
                parameters[4] = new SqlParameter("@EditEmpId", SqlDbType.Int);
                parameters[4].Value = EditEmpId;
                return BaseDataAccessor.ExecuteWithResult("spAddUpdateEmployee_NonPayrollBenefit", parameters);
            }
          #endregion
          ...
          #region AddUpdateEmployeeDeductions
            ...
            #endregion
            #region DeleteEmployeeIncentive
            public static String DeleteEmployeeIncentive(Int32 EmpId, Int32 PayComponentID, Int32 EditEmpID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteEmployeeIncentive", parameters);
            }
            #endregion
            #region DeleteEmployeeNonPayrollBenefit
            public static String DeleteEmployeeNonPayrollBenefit(Int32 EmpId, Int32 PayComponentID, Int32 EditEmpID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteEmployeeNonPayrollBenefit", parameters);
            }
            #endregion
           ...
           public static String DeleteEmployeeDependent(Int32 EmpId, Int32 DependentID)
            ...
            #region ChangePassword_PrivilegedUsers
            public static String ChangePassword_PrivilegedUsers(Int32 EmpId, String ContactEmailAddress, String NewPassword, Int32 RequestorID)
            {
                ...
                parameters[1] = new SqlParameter("@ContactEmailAddress", SqlDbType.VarChar, 50);
                parameters[1].Value = ContactEmailAddress;
                ...
                parameters[3] = new SqlParameter("@RequestorID", SqlDbType.Int);
                parameters[3].Value = RequestorID;
                return BaseDataAccessor.ExecuteWithResult("spChangePassword_PrivilegedUsers", parameters);
            ...
            #region RetrieveReports
            public static DataSet RetrieveReports(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetReportsList", parameters);
                return dataSet;
            ...
            #region AddUpdateTAConfig
            public static String AddUpdateTAConfig(Int32 RequestorID, Int32 DivisionID, Int32 LocationID, Boolean EmpEditAccess, Boolean EmpDeleteAccess, Boolean SupEditAccess, Boolean LunchAllowed, Boolean OTAllowed, Int32 MaxOTMins)
            {
                SqlParameter[] parameters = new SqlParameter[9];
                ...
                parameters[3] = new SqlParameter("@EmpEditAccess", SqlDbType.Bit);
                parameters[3].Value = EmpEditAccess;

                parameters[4] = new SqlParameter("@EmpDeleteAccess", SqlDbType.Bit);
                parameters[4].Value = EmpDeleteAccess;

                parameters[5] = new SqlParameter("@SupEditAccess", SqlDbType.Bit);
                parameters[5].Value = SupEditAccess;

                parameters[6] = new SqlParameter("@LunchAllowed", SqlDbType.Bit);
                parameters[6].Value = LunchAllowed;

                parameters[7] = new SqlParameter("@OTAllowed", SqlDbType.Bit);
                parameters[7].Value = OTAllowed;

                parameters[8] = new SqlParameter("@MaxOTMins", SqlDbType.Int);
                parameters[8].Value = MaxOTMins;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdate_TAConfig", parameters);
            }
            #endregion

            #region RetrieveTAConfigList
            public static DataSet RetrieveTAConfigList(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetTAConfig", parameters);
                return dataSet;

            }
            #endregion

            #region AddUpdateTAShiftMaster
            public static String AddUpdateTAShiftMaster(Int32 RequestorID, Int32 ShiftID, Int32 DivisionID, Int32 LocationID, String ShiftName, String ShiftCode, 
                String InTime, String OutTime, Boolean LateAllowed, Boolean EarlyAllowed, Boolean EndsNextDay, Boolean LunchAllowed, Int32 FixedLunchMins,
                Boolean BreakAllowed, Int32 FixedBreakMins, Int32 FullDayMins, Int32 HalfDayMins, Boolean OTAllowed, Int32 GracePeriod, Int32 OTOffset, Boolean IsDefault)
            {
                ...
                parameters[1] = new SqlParameter("@ShiftID", SqlDbType.Int);
                ...
                parameters[4] = new SqlParameter("@ShiftName", SqlDbType.VarChar, 50);
                parameters[4].Value = ShiftName;

                parameters[5] = new SqlParameter("@ShiftCode", SqlDbType.VarChar, 50);
                parameters[5].Value = ShiftCode;

                parameters[6] = new SqlParameter("@InTime", SqlDbType.VarChar, 30);
                parameters[6].Value = InTime;

                parameters[7] = new SqlParameter("@OutTime", SqlDbType.VarChar, 30);
                parameters[7].Value = OutTime;

                parameters[8] = new SqlParameter("@LateAllowed", SqlDbType.Bit);
                parameters[8].Value = LateAllowed;

                parameters[9] = new SqlParameter("@EarlyAllowed", SqlDbType.Bit);
                parameters[9].Value = EarlyAllowed;

                parameters[10] = new SqlParameter("@LunchAllowed", SqlDbType.Bit);
                parameters[10].Value = LunchAllowed;

                parameters[11] = new SqlParameter("@EndsNextDay", SqlDbType.Bit);
                parameters[11].Value = EndsNextDay;
                
                parameters[12] = new SqlParameter("@FixedLunchMins", SqlDbType.Int);
                parameters[12].Value = FixedLunchMins;

                parameters[13] = new SqlParameter("@BreakAllowed", SqlDbType.Bit);
                parameters[13].Value = BreakAllowed;

                parameters[14] = new SqlParameter("@FixedBreakMins", SqlDbType.Int);
                parameters[14].Value = FixedBreakMins;

                parameters[15] = new SqlParameter("@FullDayMins", SqlDbType.Int);
                parameters[15].Value = FullDayMins;

                parameters[16] = new SqlParameter("@HalfDayMins", SqlDbType.Int);
                parameters[16].Value = HalfDayMins;

                parameters[17] = new SqlParameter("@OTAllowed", SqlDbType.Bit);
                parameters[17].Value = OTAllowed;

                parameters[18] = new SqlParameter("@GracePeriod", SqlDbType.Int);
                parameters[18].Value = GracePeriod;

                parameters[19] = new SqlParameter("@OTOffset", SqlDbType.Int);
                parameters[19].Value = OTOffset;

                parameters[20] = new SqlParameter("@IsDefault", SqlDbType.Bit);
                parameters[20].Value = IsDefault;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdate_TAShiftMaster", parameters);
            }
            #endregion

            #region RetrieveTAShiftMaster
            public static DataSet RetrieveTAShiftMaster(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetTAShiftMaster", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveShiftListByEmpID
            public static NamedCollection[] RetrieveShiftListByEmpID(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                return RetrieveCollection("spGetShiftListByEmpID", parameters);
            }
            #endregion

            #region AddUpdateEmpShiftAssigment
            public static String AddUpdateEmpShiftAssigment(Int32 EmpShiftID, Int32 EmpId, Int32 ShiftTypeId, String Shift_StartDate, String Shift_EndDate, Int32 AssigneeId)
            {
                SqlParameter[] parameters = new SqlParameter[6];

                parameters[0] = new SqlParameter("@EmpShiftID", SqlDbType.Int);
                parameters[0].Value = EmpShiftID;
                parameters[1] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[1].Value = EmpId;
                parameters[2] = new SqlParameter("@ShiftTypeId", SqlDbType.Int);
                parameters[2].Value = ShiftTypeId;
                parameters[3] = new SqlParameter("@Shift_StartDate", SqlDbType.VarChar, 25);
                parameters[3].Value = Shift_StartDate;
                parameters[4] = new SqlParameter("@Shift_EndDate", SqlDbType.VarChar, 25);
                parameters[4].Value = Shift_EndDate;
                parameters[5] = new SqlParameter("@AssigneeId", SqlDbType.Int);
                parameters[5].Value = AssigneeId;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdate_TAShiftAssignment", parameters);
            }
            #endregion

            #region RetrieveShiftAssignments
            public static DataSet RetrieveShiftAssignments(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("[spGetShiftAssignments]", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveShiftAssignmentInfo
            public static DataSet RetrieveShiftAssignmentInfo(Int32 EmpShiftID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpShiftID", SqlDbType.Int);
                parameters[0].Value = EmpShiftID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetShiftAssignmentInfo", parameters);
                return dataSet;
            }
            #endregion

            #region DeleteShiftAssignment
            public static String DeleteShiftAssignment(Int32 EmpShiftID, Int32 EmpId)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteEmpShiftAssignment", parameters);
            }
            #endregion

            #region RetrieveMAReasonTypeLookup
            public static NamedCollection[] RetrieveMAReasonTypeLookup()
            {

                return RetrieveCollection("spGetMAReasonTypeLookup", null);

            }
            #endregion

            #region AddUpdateMAPunchRequest
            public static DataSet AddUpdateMAPunchRequest(Int32 MAPunchID, Int32 EmpId, String PunchingDate, String PunchInTime, String PunchOutTime, Int32 ReasonTypeId, String Comments)
            {
                SqlParameter[] parameters = new SqlParameter[7];

                parameters[0] = new SqlParameter("@MAPunchID", SqlDbType.Int);
                parameters[0].Value = MAPunchID;
                parameters[1] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[1].Value = EmpId;
                parameters[2] = new SqlParameter("@PunchingDate", SqlDbType.VarChar, 25);
                parameters[2].Value = PunchingDate;
                parameters[3] = new SqlParameter("@PunchInTime", SqlDbType.VarChar, 25);
                parameters[3].Value = PunchInTime;
                parameters[4] = new SqlParameter("@PunchOutTime", SqlDbType.VarChar, 25);
                parameters[4].Value = PunchOutTime;
                parameters[5] = new SqlParameter("@ReasonTypeId", SqlDbType.Int);
                parameters[5].Value = ReasonTypeId;
                parameters[6] = new SqlParameter("@Comments", SqlDbType.VarChar, 100);
                parameters[6].Value = Comments;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spAddUpdate_MAPunchRequest", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveMAPunchRequests
            public static DataSet RetrieveMAPunchRequests(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("[spGetMAPunchRequests]", parameters);
                return dataSet;
            }
            #endregion  

            
            #region DeleteMAPunchRequest
            public static String DeleteMAPunchRequest(Int32 MAPunchID, Int32 EmpId)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteMAPunchRequest", parameters);
            }
            #endregion

            #region RetrieveEmpMonthlyAttendance
            public static DataSet RetrieveEmpMonthlyAttendance(Int32 EmpId, String MonthYear)
            {
                SqlParameter[] parameters = new SqlParameter[2];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                ...
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetEmployee_MonthlyAttendance", parameters);
                return dataSet;

            }
            #endregion 

            #region RetrieveAttendanceRequests_Approval
            public static DataSet RetrieveAttendanceRequests_Approval(Int32 EmpId)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@EmpId", SqlDbType.Int);
                parameters[0].Value = EmpId;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetAttendanceRequests_Approval", parameters);
                return dataSet;
            }
            #endregion  

            #region Appprove_AttendanceRequest
            public static String Appprove_AttendanceRequest(Int32 MAPunchID, Int32 EmpId, String Approver_Comments, Int32 Approval, Int32 Approver_ID)
            {
                SqlParameter[] parameters = new SqlParameter[5];
                ...
                parameters[4] = new SqlParameter("@Approver_ID", SqlDbType.Int);
                parameters[4].Value = Approver_ID;

                String result = BaseDataAccessor.ExecuteWithResult("spApprove_AttendanceRequest", parameters);
                return result;
            }
            #endregion
